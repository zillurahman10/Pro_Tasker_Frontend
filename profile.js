async function loadClientData(params) {
    const response = await fetch(`http://127.0.0.1:8000/clients/${params}`);
...
async function loadFreelancerData() {
    ...
    const response = await fetch(`http://127.0.0.1:8000/freelancers/${freelancerId}`);
    const data = await response.json();
    return data;
}

async function loadPortfolioData(params) {
    const response = await fetch(`http://127.0.0.1:8000/portfolios/${params}`);
    const data = await response.json();
    return data;
}

async function loadProjectData(params) {
    const response = await fetch(`http://127.0.0.1:8000/projects/${params}`);
    const data = await response.json();
    return data;
}
